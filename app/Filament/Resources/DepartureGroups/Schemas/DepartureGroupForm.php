...
class DepartureGroupForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Tabs::make('Form Manifest Keberangkatan')
                    ->tabs([
                        Tabs\Tab::make('Data Grup')
                            ->icon('heroicon-o-clipboard-document-list')
                            ->schema([
                                Section::make('Informasi Grup Keberangkatan')
                                    ->description('Data utama grup keberangkatan, paket, kuota seat, dan status operasional.')
                                    ->schema([
                                        Grid::make([
                                            'default' => 1,
                                            'xl' => 2,
                        ...
                        Tabs\Tab::make('Jadwal & Penerbangan')
                            ->icon('heroicon-o-paper-airplane')
                            ->schema([
                                Section::make('Jadwal Keberangkatan')
                                    ->description('Atur tanggal berangkat, tanggal pulang, dan waktu penerbangan.')
                                    ->schema([
                                        Grid::make([
                                            'default' => 1,
                                            'md' => 2,
                                ...
                                Section::make('Informasi Penerbangan')
                                    ->description('Bandara, maskapai, dan nomor penerbangan jamaah.')
                                    ->schema([
                                        Grid::make([
                                            'default' => 1,
                                            'md' => 2,
                        ...
                        Tabs\Tab::make('Akomodasi & Pembimbing')
                            ->icon('heroicon-o-building-office-2')
                            ->schema([
                                Section::make('Hotel dan Pembimbing')
                                    ->description('Data hotel, tour leader, muthawif, titik kumpul, dan catatan grup.')
                                    ->schema([
                                        Grid::make([
                                            'default' => 1,
                                            'md' => 2,
                        ...
                        Tabs\Tab::make('Ringkasan Seat')
                            ->icon('heroicon-o-chart-bar')
                            ->schema([
                                Section::make('Ringkasan Seat')
                                    ->description('Menampilkan jumlah kuota, seat terisi, dan sisa seat pada grup keberangkatan.')
                                    ->schema([
                        ...
                        Tabs\Tab::make('Peserta Manifest')
                                ...
                                Section::make('Peserta Manifest')
                                    ...
                                    ->schema([
                                        Repeater::make('participants')
                                            ...
                                            ->schema([
                                                Tabs::make('Detail Peserta Manifest')
                                                    ->tabs([
                                                        ...
                                                        Tabs\Tab::make('Status Keberangkatan')
