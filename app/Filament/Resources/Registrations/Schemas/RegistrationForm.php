...
class RegistrationForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Tabs::make('Form Pendaftaran Jamaah')
                    ->tabs([
                        Tabs\Tab::make('Data Booking')
                            ->icon('heroicon-o-clipboard-document-list')
                            ->schema([
                                Section::make('Data Booking / Pendaftar Utama')
                                    ->description('Data utama pendaftaran. Data jamaah per orang ada pada tab Peserta Jamaah.')
                                    ->schema([
                                        Grid::make([
                                            'default' => 1,
                                            'xl' => 2,
                        ...
                        Tabs\Tab::make('Ringkasan Pembayaran')
